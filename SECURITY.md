...
**On rewards, before you spend hours on a report.** Kerne may offer a discretionary reward for a valid, previously unknown vulnerability, prioritising critical findings. This policy creates no contractual obligation and no reward is offered or implied for a report submitted today. There are already 1,250 USDC of unpaid reward commitments ahead of you, made in writing to four researchers, and they are still owed.

**What Kerne holds is published as a live read, not restated here.** [kerne.fi/api/reward-capacity](https://kerne.fi/api/reward-capacity) returns the total, the Base block it was read at, the three accounts it sums, and a shell command per account so you can check each one against chain yourself. The human-readable version, with the commitments queue beside it, is at [kerne.fi/security#reward-capacity](https://kerne.fi/security#reward-capacity). Those two are the authoritative version of this paragraph.

**Correction, August 14, 2026.** Until today this paragraph published "as of July 29, 2026 the total dollar balance across every account Kerne controls is $29.52" as a flat number with no way to refresh it, and it stayed on this page for sixteen days. It was wrong within a week: the same three accounts were re-measured on August 3 and came back **4.4 times larger**, which is why every Kerne surface now derives that figure from the endpoint above rather than printing one. It is also volatile enough that no printed number could survive: it fell by close to a quarter in the twenty-four hours before this correction was written, because one of the three accounts is a margin balance that moves with the mark price. A stale, understated figure on the page a researcher reads before deciding whether to spend a weekend on Kerne is the most discouraging thing this file could carry, and it was carrying it. No reward-capacity figure is hardcoded anywhere on this property now.

**What Kerne can pay for today, stated plainly.** Not a bounty. It can pay for commissioned review: the Whitehat Desk pays the researcher **70 percent of the fee in USDC within 72 hours of delivery**, which is 1,750 dollars on a focused sweep and 3,500 on an extended one. No sweep has ever been booked through it and nobody has ever been paid through it, so that is an option on future work rather than a job, and the supply side is counted rather than asserted at [kerne.fi/security/desk-supply](https://kerne.fi/security/desk-supply). Desk work does not settle, offset or re-queue the 1,250. The work is genuinely wanted. The money for bounties is not there yet, and you should know that first.
